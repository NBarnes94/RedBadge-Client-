...
class VGEdit extends Component<VGEProps, VGEDetails>{
...
//         return (
//             <div>
//                 <Button onClick={this.toggle} className="modalButtons">Edit this game</Button>
//                 <Form onSubmit={(e) => this.handleSubmit(e)}>
//                     <Modal
//                         className="modal" isOpen={this.state.modal} fade={true} toggle={this.toggle}
//                     >
...
//                             <Input autoComplete="off" onChange={(e) => this.setState({ description: e.target.value })} name="description" type="textarea" value={this.state.description} />
//                             {/* <Label>Status</Label> */}
//                             {/* <Select onChange={(e)=> this.setState({status: e.target.value})} name="status" value={this.state.status}>
//                             <MenuItem value=""><em>None</em></MenuItem>
//                             <MenuItem></MenuItem>
...
export default withStyles(styles, { withTheme: true })(VGEdit);